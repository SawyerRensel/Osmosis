...
-   :lucide-brain-circuit:{ .lg .middle } __Mind Mapping__
    ...
    See your notes as a fully interactive, editable mind map. Headings become branches, lists become nodes. Edit the map and the markdown updates instantly.

    [:octicons-arrow-right-24: Mind Mapping](mind-mapping/index.md)

-   :lucide-layers:{ .lg .middle } __Flashcards__

    ---

    Create flashcards directly in your notes. Basic Q&A, bidirectional, type-in, cloze deletions, and code cloze cards — all in a simple code fence syntax.

    [:octicons-arrow-right-24: Flashcards](flashcards/index.md)

-   :lucide-graduation-cap:{ .lg .middle } __Spaced Repetition__

    ---

    Study with the FSRS algorithm in three modes: sequential card review, contextual inline study, and spatial study on the mind map itself.
